    ...
    <div className="mb-6 sm:mb-8 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Button
          ...
          className="flex-1 sm:flex-none transition-all duration-200 h-12 text-base font-semibold bg-foreground text-background hover:shadow-lg hover:-translate-y-0.5"
        >
          All ({contacts.length})
        </Button>
      </div>
